...
var ASM_CONSTS = {
  3914856: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3914911: ($0) => { performance.now = function() { return $0; }; },  
 3914959: ($0) => { performance.now = function() { return $0; }; },  
 3915007: () => { performance.now = Module['emscripten_get_now_backup']; }
};
